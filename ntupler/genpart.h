...
// Mon Jul 28 14:20:23 2014 by ROOT version 5.32/00
// from TTree hi/Tree of Hydjet Events
...
public :
   ...
   Int_t           mult;
   Float_t         pt[347];   //[mult]
   Float_t         eta[347];   //[mult]
   Float_t         phi[347];   //[mult]
   Int_t           pdg[347];   //[mult]
   Int_t           chg[347];   //[mult]
   Float_t         vx;
   Float_t         vy;
